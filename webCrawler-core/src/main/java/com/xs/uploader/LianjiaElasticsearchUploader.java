 ...
 * 链家-上传数据到ES处理类
 */
public class LianjiaElasticsearchUploader extends ElasticsearchUploader implements OutPipeline<Document>, AutoCloseable {
    ...
    public LianjiaElasticsearchUploader(String index, String type) {
        this.index = index;
        this.type = type;
    }
